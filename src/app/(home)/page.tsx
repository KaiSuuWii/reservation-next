        ...
        <div className="flex flex-col items-center justify-center space-y-20 p-20">
            ...
            <div className="flex gap-6">
                <div className="p-3 bg-[#cccccc] rounded-lg w-60 h-70">
                    <div className="w-full h-50 bg-white rounded-lg shadow-2xs"></div>
            ...
            <div className="flex flex-col items-center gap-4 font-semibold">
                ...
                <Link href="/login">
                <button type='submit' className="w-100 h-15 text-md bg-[#283971] rounded-2xl text-white font-bold hover:cursor-pointer hover:bg-[#1e2c5a]">Login</button>
                </Link>
            </div>
        </div>
    );
